            ...
            <div className="row">
                ...
                <div className="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <li><a href="https://www.youtube.com/watch?v=KBgfov9Pi7I" target="_blank">Cómo usar el diccionario</a></li>
                        ...
                        <li><a href="https://www.youtube.com/watch?v=sY8372JVZCk" target="_blank">Preliminares del diccionario</a></li>
                    </ul>
                </div>
                ...
                <div className="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul className="list-unstyled">
                        <li><a href="https://cv4.ucm.es/moodle/course/view.php?id=115038" target="_blank">Curso de iniciación al alemán</a></li>
